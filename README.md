...
| 8. Create User class | [console.py](./console.py) [/models/engine/file_storage.py](./models/engine/file_storage.py) [/models/user.py](./dev/models/user.py) | Dynamically implements a user class |
